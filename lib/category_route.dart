...
/// Carga en datos de conversión de unidades y muestra los datos.
///
/// Esta es la pantalla principal de nuestra aplicación. Recupera datos de conversión de un
/// activo JSON y de una API. Muestra las [Categorías] en el panel posterior
/// de un widget [Backdrop] y muestra el [UnitConverter] en el panel frontal.
///
/// Mientras se llama CategoryRoute, un nombre más apropiado sería CategoryScreen,
/// porque es responsable de la UI en el destino de la ruta.
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Widget build(BuildContext context) {
    ...
    return Backdrop(
      ...
      backPanel: listView,
      frontTitle: Text('Convertidor de Unidad'),
      backTitle: Text('Seleccione Categoria'),
    );
  }
}
